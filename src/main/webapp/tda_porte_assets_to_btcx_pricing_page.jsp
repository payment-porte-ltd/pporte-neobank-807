								...
								<div class="col-md-12 col-lg-12">
									<div class="card" style="margin-top: -165px;">
										<div class="card-header">
											<div class="card-title">BTCx Markup Rate against Porte
												Assets</div>
											<div class="ml-auto">
												...
												<table id="viewbtcxpricingtable"
													...
													<tbody>
														...
														<tr>
															...
															<td>+ <%=((AssetCoin) arrPorteAssetsToBTCxMarkUpRates.get(i)).getMarkupRate()%>%
																Mark-up Rate on <%=((AssetCoin) arrPorteAssetsToBTCxMarkUpRates.get(i)).getAssetCode()%>
																Offer
															</td>
													...
													<div class="card-body">
														<div class="row">
															<div class="col-xl-6">
																...
																<div class="form-group">
																	<label class="form-label">Markup Rate</label> <input
																...
																<div class="form-group ">
																	...
																	<div class="input-two-box">
																		...
																		<span style="color: #2b65ec; display: none"
																			id="exchangerate">+ <span id=spansexchangerate>
																				0</span>% Mark-up Rate on <span id="spansellassetcode">
																		</span> Offer
																		</span>
																	</div>
