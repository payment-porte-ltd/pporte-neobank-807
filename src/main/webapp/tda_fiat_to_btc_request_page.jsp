...
<!-- Title -->
<title>View Fiat to BTC Requests</title>
<!--Bootstrap.min css-->
<link rel="stylesheet"
...
<body class="app sidebar-mini rtl">
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">BTC Requests</div>
								</div>
								<div class="card-body">
										...
										<table id="example"
											...
											<thead>
												<tr>
													...
													<th class="wd-15p">BTC Address Key</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="largemodal1">Approve BTC Request</h5>
					...
					<form id="private-key-form">
						...
						<div class="form-group">
							<input type="password" class="form-control" id="privatekey"
								name="privatekey" placeholder="Enter Private Key">
						</div>
						<div class="form-group">
	...
	<script src="assets/js/_tda_fiat_to_btc_request_page.js"></script>
</body>
</html>
