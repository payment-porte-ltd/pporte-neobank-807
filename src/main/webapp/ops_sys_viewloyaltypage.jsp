...
try{
	...
	if (request.getAttribute("allloyaltyrules") !=null) arrLoyaltyRules = (ArrayList<LoyaltyRules>) request.getAttribute("allloyaltyrules");
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Loyalty Rules</div>
									<div class="ml-auto">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="viewloyaltyrulestable"
											...
											<tbody>
												...
												<tr>
													<td colspan="9"><span id="ops_all_bin_list_errormsg1">No
															Loyalty Rules available </span></td>
												</tr>
												<%
												}
												%>
												...
												<form id="addloyaltyrules-from" method="post">
													<div class="card-body">
														<div class="row">
															<div class="col-xl-6">
																...
																<div class="form-group">
																	...
																	<label class="form-label">Pay Mode</label> <select
																		...
																		id="seladdpaymode"
																		onchange="javascript:UpdateDescriptionParam(); return false;">
																		<option value="">Select Pay Mode</option>
																		<% for (int i=0; i<arrTransactionRules.size();i++){ %>
																		<option
																			value="<%=((TransactionRules) arrTransactionRules.get(i)).getPayMode()%>,<%=((TransactionRules) arrTransactionRules.get(i)).getRuleDesc()%>
																		"><%=((TransactionRules) arrTransactionRules.get(i)).getRuleDesc()%></option>
																		<%} %>
																	</select>
																	<%} %>
																</div>
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label class="form-label">Transaction Rule</label> <input
...
<%
	...
	if(arrLoyaltyRules!=null)arrLoyaltyRules=null; if(hashStatus!=null)hashStatus=null;
