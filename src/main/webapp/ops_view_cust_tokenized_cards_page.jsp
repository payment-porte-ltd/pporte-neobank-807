...
try{
	...
	if(request.getAttribute("allcustomers")!=null)	arrCustomerDetails = (ArrayList<Customer>)request.getAttribute("allcustomers");
...
<body class="app sidebar-mini rtl">
				...
				<div class="side-app" style="height: 89vh;">
										...
										<table id="txn_datatable"
											...
											<tbody>
												...
												<tr>
													...
													<td><%=((Customer)arrCustomerDetails.get(i)).getCardAlias()%>
													</td>
													<td class="text-center align-middle">
														<div class="btn-group align-top">
															<button class="btn btn-sm btn-primary badge"
																type="button"
																onClick="javascript:fnOpsViewSpecificCards
																('<%=((Customer) arrCustomerDetails.get(i)).getRelationshipNo()%>' ,'<%=((Customer)arrCustomerDetails.get(i)).getTokenId()%>');return false;">View
																Card</button>
														</div>
													</td>
													<% }
												...
												<tr>
													<td colspan="9"><span id="ops_all_bin_list_errormsg1">Please
															search to view customer card details</span></td>
												</tr>
												<% } %>
					...
					<form method="post" id="pendingcust-form">
						<input type="hidden" name="qs" value=""> <input
							...
							name="hdncustomerrelno" value=""> <input type="hidden"
							name="hdncustphone" value=""> <input type="hidden"
							name="hdntokenid" value=""> <input type="hidden"
							name="hdncardalias" value=""> <input type="hidden"
	...
	<script src="assets/js/_ops_view_cust_tokenized_cards_page.js"></script>
