...
try{
	...
	if(request.getAttribute("portedistributionpubkey")!=null)	portePublicKey = (String)request.getAttribute("portedistributionpubkey");
	if(request.getAttribute("vesseldistributionpubkey")!=null)	vesselPublicKey = (String)request.getAttribute("vesseldistributionpubkey");
	
	if(request.getAttribute("portedistributionaccbal")!=null)	porteDistributionAccountBal = (String)request.getAttribute("portedistributionaccbal");
	if(request.getAttribute("vesseldistributionaccbal")!=null)	vesselDistributionAccountBal = (String)request.getAttribute("vesseldistributionaccbal");
					...
					<div class="page-header">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#">Manage Digital
									Assets</a></li>
							<li class="breadcrumb-item active" aria-current="page">Distribution
								Account Details</li>
						</ol>
						<!-- End breadcrumb -->
					</div>
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Distribution Account Details</h3>
								</div>
																			...
																			<div class="row">
																				<div class="col">
																					<div class="form-label">
																						<label class="form-label">Distribution
													...
													<div class="row row-cards">
														<div class="col-md-12 col-lg-12">
															<div class="card">
																<div class="card-body">
																	<div class="table-responsive">
																		<table id="porte_txns" style="color: black"
