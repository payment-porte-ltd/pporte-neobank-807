...
<!-- Title -->
<title>View BTC Pending Transactions</title>
...
<body class="app sidebar-mini rtl">
					...
					<div class="page-header">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><span
								id="breadcrumb-item-view-pending-txn">View BTCx Pending
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<span id="card-tittle-stellar-btc-pending-txn">Stellar
											Bitcoin Pending Transactions</span>
									</div>
								</div>
								<div class="card-body">
										...
										<table id="pendingtxntable"
											...
											<thead>
												<tr>
													...
													<th class="wd-15p"><span id="th-asset-code">Asset
															Code</span></th>
													<th class="wd-20p"><span id="th-status">Status</span></th>
													<th class="wd-15p"><span id="th-date">Date</span></th>
												</tr>
											</thead>
											<tbody>
											...
											%>
												<tr>
													...
													<td><%= new BigDecimal(((Transaction)transactions.get(i)).getCoinAmount()) %></td>
												...
												<tr>
													<td><span id="span_no_data_present">No data
															Present</span></td>
												</tr>
												<% } %>
	...
	<script src="assets/js/_cust_view_pending_btcx_page.js"></script>
	<script>
