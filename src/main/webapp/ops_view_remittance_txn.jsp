...
<!-- Title -->
<title>Remittance Transactions</title>
...
<body class="app sidebar-mini rtl" onload="fnGetFiatTxn()">
										...
										<div class="card-body">
											<form id="filter-txn-form" method="post">
												...
												<a class="btn theme-btn" href="#"
													onclick="javascript:fnGetFilteredTxn()"
													style="display: flex; justify-content: center;">Search
	...
	<!-- Custom js-->
	<script src="assets/js/_ops_view_remittance_txn.js"></script>
