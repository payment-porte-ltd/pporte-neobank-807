i18next.init({
	...
	resources: {
	  EN: {
		translation: {
			...
			"breadcrumb-item-pending-txn":"View Pending Transactions",
			"card-title-buy-pending-txn":"Buy Coins Pending Transactions",
			"th-txn-code":"Transaction Code",
			"th-txn-amount":"Amount",
			"th-asset-code":"Asset Code",
			"th-txn-status":"Status",
			"th-txn-date":"Date",
	  ...
	  ES: {
		  translation: {
			...
			"breadcrumb-item-pending-txn":"Ver transacciones pendientes",
			"card-title-buy-pending-txn":"Comprar monedas transacciones pendientes",
			"th-txn-code":"Codigo de transacción",
			"th-txn-amount":"Monto",
			"th-asset-code":"Código de activo",
			"th-txn-status":"Estado",
			"th-txn-date":"Fecha",
  ...
  function updateContent() {
       ...
       // $('#greeting').text(i18next.t('greeting'));
        ...
        $('#card-title-buy-pending-txn').text(i18next.t('card-title-buy-pending-txn'));
        ...
        $('#th-txn-status').text(i18next.t('th-txn-status'));
        $('#th-txn-status').text(i18next.t('th-txn-status'));
