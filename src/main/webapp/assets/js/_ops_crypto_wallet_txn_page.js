...
function fnGetCryptoTxn(){
    $('#get-txn-form input[name="qs"]').val('wal');
    $('#get-txn-form input[name="rules"]').val('get_crpto_txn');
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#card_txn_header').html('Crypto Wallet Transactions')
            if(data.error=='false'){
...
function fnGetFilteredTxn(){
   $( "#filter-txn-form" ).validate( {
    ...
    if($( "#filter-txn-form" ).valid()){
        ...
        $('#filter-txn-form input[name="rules"]').val('get_crpto_txn_btn_dates');
