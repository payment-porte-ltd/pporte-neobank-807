i18next.init({
	...
	resources: {
	  EN: {
		translation: {
			...
			"breadcrumb-item-pending-txn":"View BTC Pending Transactions",
			"card-title-bitcoin-txn":"Bitcoin Pending Transactions",
			"th_txn_cod":"Transaction Code",
			"th_amount":"Amount",
			"th_asset_code":"Asset Code",
			"th_status":"Status",
			"th_date":"Date",
	  ...
	  ES: {
		  translation: {
			...
			//"greeting":"Cliente",
			"breadcrumb-item-bitcoin":"Bitcoin",
			"breadcrumb-item-pending-txn":"Ver transacciones pendientes de BTC",
			"card-title-bitcoin-txn":"Transacciones pendientes de Bitcoin",
			"th_txn_cod":"Codigo de transacción",
			"th_amount":"Monto",
			"th_asset_code":"Código de activo",
			"th_status":"Estado",
			"th_date":"Fecha",
  ...
  function updateContent() {
       ...
       // $('#greeting').text(i18next.t('greeting'));
        ...
        $('#breadcrumb-item-pending-txn').text(i18next.t('breadcrumb-item-pending-txn'));
        $('#card-title-bitcoin-txn').text(i18next.t('card-title-bitcoin-txn'));
        $('#th_txn_cod').text(i18next.t('th_txn_cod'));
        $('#th_amount').text(i18next.t('th_amount'));
        $('#th_asset_code').text(i18next.t('th_asset_code'));
        $('#th_status').text(i18next.t('th_status'));
        $('#th_date').text(i18next.t('th_date'));
