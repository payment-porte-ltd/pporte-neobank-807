...
function fnGetlastFiveTxn(){
    ...
    $('#get-txn-form input[name="rules"]').val('get_last_five_porte_txn');
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#card_txn_header').html('Last Five Transactions')
            if(data.error=='false'){
...
function fnGetFilteredTxn(){
   $( "#filter-txn-form" ).validate( {
    ...
    if($( "#filter-txn-form" ).valid()){
        $('#filter-txn-form input[name="qs"]').val('porte');
        $('#filter-txn-form input[name="rules"]').val('get_porte_txn_btn_dates');
