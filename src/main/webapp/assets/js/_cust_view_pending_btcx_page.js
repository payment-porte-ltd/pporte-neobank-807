i18next.init({
	...
	resources: {
	  EN: {
		translation: {
			...
			"breadcrumb-item-view-pending-txn":"View BTCx Pending Transactions",
			"card-tittle-stellar-btc-pending-txn":"Stellar Bitcoin Pending Transactions",
			"th-txn-code":"Transaction Code",
			"th-txn-amount":"Amount",
			"th-asset-code":"Asset Code",
			"th-status":"Status",
			"th-date":"Date",
			"span_no_data_present":"No data Present"
	  ...
	  ES: {
		  translation: {
			...
			//"greeting":"Cliente",
			"breadcrumb-item-stellar-bitcoin":"Stellar Bitcoin",
			"breadcrumb-item-view-pending-txn":"Ver transacciones pendientes de BTCx",
			"card-tittle-stellar-btc-pending-txn":"Stellar Bitcoin transacciones pendientes",
			"th-txn-code":"Codigo de transacción",
			"th-txn-amount":"Monto",
			"th-asset-code":"Código de activo",
			"th-status":"Estado",
			"th-date":"Fecha",
			"span_no_data_present":"Sin datos Presente"
			}
		},
	}
  }, function(err, t) {
  ...
  function updateContent() {
       ...
       // $('#greeting').text(i18next.t('greeting'));
        ...
        $('#breadcrumb-item-view-pending-txn').text(i18next.t('breadcrumb-item-view-pending-txn'));
        $('#card-tittle-stellar-btc-pending-txn').text(i18next.t('card-tittle-stellar-btc-pending-txn'));
        $('#th-txn-code').text(i18next.t('th-txn-code'));
        $('#th-txn-amount').text(i18next.t('th-txn-amount'));
        $('#th-asset-code').text(i18next.t('th-asset-code'));
        $('#th-status').text(i18next.t('th-status'));
        $('#th-date').text(i18next.t('th-date'));
        $('#span_no_data_present').text(i18next.t('span_no_data_present'));
  }
