i18next.init({
	...
	resources: {
	  EN: {
		translation: {
			...
			"breadcrumb-item-assets":"Assets",
			"spn_no_wallets_available":"No External Wallets",
	  ...
	  ES: {
		  translation: {
			...
			"breadcrumb-item-assets":"Activos",
			"spn_no_wallets_available":"Sin carteras externas",
			}
		},
	}
  }, function(err, t) {
  ...
  function updateContent() {
       ...
       // $('#greeting').text(i18next.t('greeting'));
        ...
        $('#breadcrumb-item-assets').text(i18next.t('breadcrumb-item-assets'));
        $('#spn_no_wallets_available').text(i18next.t('spn_no_wallets_available'));
