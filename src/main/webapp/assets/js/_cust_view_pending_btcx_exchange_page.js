i18next.init({
	...
	resources: {
	  EN: {
		translation: {
			...
			//"greeting":"Customer",
			"breadcrumb-item-stellar-bitcoin":"Stellar Bitcoin",
			"breadcrumb-item-view-btc-swap-pending":"View BTC Swap Pending Transactions",
			"card-title-pending-txn":"Stellar Bitcoin Pending Transactions",
			"th-txn-code":"Transaction Code",
			"th-src-asset":"Source Asset",
			"th-src-amount":"Source Amount",
			"th-dest-asset":"Destination Asset",
			"th-dest-amount":"Destination Amount",
			"th-txn-hash":"Transaction Hash",
			"th-txn-date":"Date",
			"spn-no-data-present":"No data Present",			
	  ...
	  ES: {
		  translation: {
			...
			//"greeting":"Cliente",
			"breadcrumb-item-stellar-bitcoin":"Stellar Bitcoin",
			"breadcrumb-item-view-btc-swap-pending":"Ver transacciones pendientes de intercambio de BTC",
			"card-title-pending-txn":"Transacciones pendientes de Bitcoin estelar",
			"th-txn-code":"Codigo de transacción",
			"th-src-asset":"Activo de origen",
			"th-src-amount":"Cantidad de origen",
			"th-dest-amount":"Activo de destino",
			"th-dest-asset":"Activo de destino",
			"th-txn-hash":"Cantidad de destino",
			"th-txn-date":"Fecha",
			"spn-no-data-present":"Sin datos Presente"
			}
		},
	}
  }, function(err, t) {
  ...
  function updateContent() {
       ...
       // $('#greeting').text(i18next.t('greeting'));
        $('#breadcrumb-item-stellar-bitcoin').text(i18next.t('breadcrumb-item-stellar-bitcoin'));
        $('#breadcrumb-item-view-btc-swap-pending').text(i18next.t('breadcrumb-item-view-btc-swap-pending'));
        $('#card-title-pending-txn').text(i18next.t('card-title-pending-txn'));
        $('#th-txn-code').text(i18next.t('th-txn-code'));
        $('#th-src-asset').text(i18next.t('th-src-asset'));
        $('#th-src-amount').text(i18next.t('th-src-amount'));
        $('#th-dest-asset').text(i18next.t('th-dest-asset'));
        $('#th-txn-hash').text(i18next.t('th-txn-hash'));
        $('#th-txn-date').text(i18next.t('th-txn-date'));
        $('#spn-no-data-present').text(i18next.t('spn-no-data-present'));
