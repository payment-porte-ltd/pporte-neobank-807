...
<body class="app sidebar-mini rtl">
					...
					<div class="page-header">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#"><span
									id="breadcrumb-item-stellar-bitcoin">Stellar Bitcoin</span></a></li>
							<li class="breadcrumb-item active" aria-current="page"><span
								id="breadcrumb-item-view-btc-swap-pending">View BTC Swap
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<span id="card-title-pending-txn">Stellar Bitcoin
										...
										<table id="example3"
											...
											<thead>
												<tr>
													<th class="wd-15p"><span id="th-txn-code">Transaction
															Code</span></th>
													<th class="wd-15p"><span id="th-src-asset">Source
															Asset</span></th>
													<th class="wd-15p"><span id="th-src-amount">Source
															Amount</span></th>
													<th class="wd-15p"><span id="th-dest-amount">Destination
															Asset</span></th>
													<th class="wd-15p"><span id="th-dest-amount">Destination
															Amount</span></th>
											...
											%>
												<tr>
													...
													<td><%= new BigDecimal(((Transaction)transactions.get(i)).getSourceAmount()) %></td>
													<td><%= ((Transaction)transactions.get(i)).getDestinationAssetCode() %></td>
													<td><%= new BigDecimal(((Transaction)transactions.get(i)).getDestinationAmount()) %></td>
	...
	<script src="assets/js/_cust_view_pending_btcx_exchange_page.js"></script>
	<script>
