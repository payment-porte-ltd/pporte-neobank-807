...
<body class="app sidebar-mini rtl">
					...
					<div class="page-header">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><span
								id="breadcrumb-item-pending-txn">View BTC Pending
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<span id="card-title-bitcoin-txn">Bitcoin Pending
											Transactions</span>
									</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table id="pendingtxntable"
											...
											<thead>
												<tr>
													<th class="wd-15p"><span id="th_txn_cod">Transaction
															Code</span></th>
													<th class="wd-15p"><span id="th_amount">Amount</span></th>
													<th class="wd-15p"><span id="th_asset_code">Asset
															Code</span></th>
													<th class="wd-20p"><span id="th_status">Status</span></th>
													<th class="wd-15p"><span id="th_date">Date</span></th>
												</tr>
											</thead>
											<tbody>
	...
	<script src="assets/js/_cust_view_pending_btc_page.js"></script>
