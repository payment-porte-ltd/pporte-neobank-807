...
<!-- Title -->
<title>Fiat Wallet Transactions</title>
...
<body class="app sidebar-mini rtl" onload="fnGetFiatTxn()">
			...
			<div class="app-content  my-3 my-md-5 toggle-content">
				<div class="side-app">
					...
					<div class="page-header">
						<ol class="breadcrumb">
							<!-- breadcrumb -->
							<li class="breadcrumb-item"><a href="#">Fiat Wallet
									Transactions</a></li>
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Search Wallet</div>
								</div>
								<div class="card-body">
										...
										<div class="row">
											...
											<div class="col text-center">
												<button type="button" class="btn btn-info mb-1 btn-block "
													onclick="javascript:fnSearchForWallet();return false;">Search</button>
											</div>
										</div>
									</form>
								</div>
	...
	<script src="assets/js/_ops_fiat_wallet_txn_page.js"></script>
