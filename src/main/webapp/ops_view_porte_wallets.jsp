...
<body class="app sidebar-mini rtl">
				...
				<div class="side-app" style="height: 89vh;">
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Stellar Customers</div>
								</div>
								<div class="card-body">
											...
											<tbody>
												...
												<tr>
													<td colspan="9"><span id="ops_all_bin_list_errormsg1">Please
															search to view customer porte wallet</span></td>
												</tr>
												<% } %>
					...
					<form method="post" id="form-txn-page">
						<input type="hidden" name="qs" value=""> <input
							...
							name="hdnpublickey" value=""> <input type="hidden"
							name="hdncustname" value=""> <input type="hidden"
							name="hdnrelno" value=""> <input type="hidden"
	...
	<script src="assets/js/_ops_view_porte_wallets.js"></script>
	<script>
