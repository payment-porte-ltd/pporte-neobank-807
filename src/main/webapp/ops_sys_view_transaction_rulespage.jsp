...
<%
ArrayList<TransactionRules> arrTransactionRules = null; ConcurrentHashMap<String, String> hashStatus = null; 
...
try{
	...
	if (request.getAttribute("alltransactionrules") !=null) arrTransactionRules = (ArrayList<TransactionRules>) request.getAttribute("alltransactionrules");
...
<body class="app sidebar-mini rtl">
		...
		<div class="page-main">
			...
			<div class="app-content  my-3 my-md-5 toggle-content">
				<div class="side-app" style="height: 89vh;">
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Transaction Rules</div>
									<div class="ml-auto">
										<div class="input-group">
											<a class="btn btn-primary text-white mr-2"
												data-toggle="modal" data-target="#addtxnruleModal"> <span>
													<i class="typcn typcn-plus"></i> Add Transaction Rules
											</span>
											</a>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="viewtransactionrulestable"
											...
											<tbody>
												...
												%>
												<tr>
													<td><%=((TransactionRules) arrTransactionRules.get(i)).getPayMode()%></td>
													<td><%=((TransactionRules) arrTransactionRules.get(i)).getRuleDesc()%></td>
													<td><%=hashUserType.get( ((TransactionRules) arrTransactionRules.get(i)).getUserType())%></td>
													<td><%=hashStatus.get( ((TransactionRules) arrTransactionRules.get(i)).getStatus())%></td>
													<td><%=((TransactionRules) arrTransactionRules.get(i)).getCreatedOn()%></td>
													<td class="text-center align-middle">
														<div class="btn-group align-top">
															<button class="btn btn-sm btn-primary badge"
																data-target="#user-form-modal" data-toggle="modal"
																type="button"
																onClick="javascript:fnEditTransactionRules('<%=((TransactionRules) arrTransactionRules.get(i)).getPayMode()%>',
																'<%=((TransactionRules) arrTransactionRules.get(i)).getRuleDesc()%>','<%=((TransactionRules) arrTransactionRules.get(i)).getUserType()%>',
																'<%=((TransactionRules) arrTransactionRules.get(i)).getStatus()%>','<%=((TransactionRules) arrTransactionRules.get(i)).getCreatedOn()%>'
																);return false;">
												...
												<tr>
													<td colspan="9"><span id="ops_all_bin_list_errormsg1">No
															Transaction Rules available </span></td>
												</tr>
												<%
												}
												%>
					...
					<!-- row end -->
					<!-- Modal -->
					<div class="modal fade" id="editLoyaltyRulesModal" tabindex="-1"
					...
					<!-- End Model -->
					<!-- Modal -->
					<div class="modal fade" id="addtxnruleModal" tabindex="-1"
						role="dialog" aria-labelledby="largemodal" aria-hidden="true">

						<div class="modal-dialog modal-lg " role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="largemodal1">Add Transaction Rule</h5>
									<button type="button" class="close" data-dismiss="modal"
										aria-label="Close">
										<span aria-hidden="true">X</span>
									</button>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary"
										data-dismiss="modal">Close</button>
									<button type="button" class="btn btn-primary"
										id="btn-addloyaltyrules">Submit</button>
								</div>
							</div>
						</div>
					</div>
	...
	<script src="assets/js/_ops_sys_view_transaction_rulespage.js"></script>
...
<%
	...
	if(arrTransactionRules !=null) arrTransactionRules=null; if(hashStatus !=null) hashStatus=null;
