...
<!-- Title -->
<title>View Raised Disputes</title>
<!--Bootstrap.min css-->
<link rel="stylesheet"
...
<body class="app sidebar-mini rtl">
											...
											<table table id="example"
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-nowrap align-middle"><%=((Disputes)aryAllDisputes.get(i)).getUserComment()%></td>
														<td class="text-nowrap align-middle"><%=((Disputes)aryAllDisputes.get(i)).getStatus()%></td>
														<td class="text-nowrap align-middle"><%=((Disputes)aryAllDisputes.get(i)).getRaisedbyUserId() %></td>
	...
	<script src="assets/js/_ops_dispute_view_cust_disptpage.js"></script>
</body>
</html>
...
<% 
	...
	if(aryAllDisputes!=null) aryAllDisputes=null; if (context!=null)context=null;
}
