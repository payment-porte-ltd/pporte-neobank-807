...
<%
List<CardDetails> listCardDetails=null;
...
try{
	...
	if(request.getAttribute("listCardDetails")!=null)	listCardDetails = (List<CardDetails>)request.getAttribute("listCardDetails");
...
<body class="app sidebar-mini rtl">
			...
			<div class="app-content  my-3 my-md-5 toggle-content">
				<div class="side-app" style="height: 89vh;">
					...
					<div class="page-header" style="margin: auto">
						<ol class="breadcrumb">
							<!-- breadcrumb -->
							<li class="breadcrumb-item"><a href="#">Manage Cards</a></li>
							<li class="breadcrumb-item active" aria-current="page">Show
								Customer's Specific Cards</li>
						</ol>
						<!-- End breadcrumb -->
					</div>
					<!-- End page-header -->
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Customers Card Details</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table id="pendingmerchtable"
											...
											<tbody>
												<% if( listCardDetails!=null){
													for(int i=0;i<listCardDetails.size();i++){       
												%>
												<tr>
													<td><%=((CardDetails)listCardDetails.get(i)).getCardAlias()%>
													</td>
													<td><%=((CardDetails)listCardDetails.get(i)).getMaskedCardNumber()%>
													</td>
													<td><%=((CardDetails)listCardDetails.get(i)).getTokenId()%>
													</td>
													<td><%=((CardDetails)listCardDetails.get(i)).getCreatedOn()%>
													</td>
													<% }
												}else{ %>
	...
	<script src="assets/js/_ops_view_specific_cust_tokenized_cards_page.js"></script>
...
<%
	...
	if (context!=null)context=null;if (listCardDetails!=null)listCardDetails=null;	
}
%>