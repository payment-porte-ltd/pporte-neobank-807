...
<body class="app sidebar-mini rtl" onload="fnGetCryptoTxn()">
			...
			<div class="app-content  my-3 my-md-5 toggle-content">
				<div class="side-app">
					...
					<div class="page-header">
						<ol class="breadcrumb">
							<!-- breadcrumb -->
							<li class="breadcrumb-item"><a href="#"> Crpto Wallet
									Transactions</a></li>
	...
	<script src="assets/js/_ops_crypto_wallet_txn_page.js"></script>
