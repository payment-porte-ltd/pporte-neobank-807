 ...
 */
@WebServlet("/cs")
public class OPSControllerServlet extends InternalWebServlet implements Servlet{
	private static final long serialVersionUID = 1L;
    private ServletContext context = null;
    private String classname=OPSControllerServlet.class.getSimpleName();
    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OPSControllerServlet() {
    	super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			try {
				...
				Utilities.callOpsException(request, response, this.context, "Session has expired, please login again.");
			} catch (Exception e1) {
