...
public class MultipartServlet extends InternalMultiPartServlet implements Servlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String action =null; Map<String, String> headerMap  = null; JsonObject jsonObj = null; Gson gson = new Gson();
		String apiKey = null;
		...
		try{
			...
			if(action != null) action = null; if(headerMap.isEmpty() == false) headerMap.clear(); if(jsonObj!=null) jsonObj = null; if(gson!=null) gson = null;
		}
	}
