...
public class CustomerDisputesDao extends HandleConnections  {
	public static String className = CustomerDisputesDao.class.getSimpleName();
	...
	public boolean addNewDispute(String transactionId, String relationshipNo, String userType, String comment,
	...
	public boolean addCommentOnADispute(String disputeId, String relationshipNo, String userType, String comment) throws Exception{
		PreparedStatement pstmt=null;
		Connection connection = null;
		String query = null;
		boolean result = false;
